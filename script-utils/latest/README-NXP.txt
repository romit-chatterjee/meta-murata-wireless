...
Build Procedure: 
================
Currently only Ubuntu 12.04, 14.04, 16.04, 20.04 and 22.04 (64-bit) distros are supported. Please install one of these
versions on your host machine/environment before invoking the "Host_Setup_for_Yocto.sh" script. Once the host 
...
--------------------------------------------------------------------
| 6.1.22_2.0.0   | Mickledore       |  imx-mickledore-6-1-22_r1.0  |
--------------------------------------------------------------------
