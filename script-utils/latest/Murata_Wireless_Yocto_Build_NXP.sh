...
#  1.26     | 10/12/2023   |    RC        |    Added support for Linux 6.1.22.
####################################################################################################
...
LINUX_KERNEL_6_1_22_STR="6.1.22"
...
iMXmickledoreStableReleaseTag="imx-mickledore-6-1-22_r1.0"
iMXmickledoreDeveloperRelease="imx-mickledore-6-1-22"

imxhardknottYocto52="5.10.52_2.1.0 GA"
imxhardknottYocto72="5.10.72_2.2.0"
imxkirkstone="5.15.32_2.0.0"
imxlangdale="6.1.1_1.0.0"
imxmickledore="6.1.22_2.0.0"
...
while true; do
	...
	echo "|  4  |     ${LINUX_KERNEL_6_1_22_STR}        | mickledore | 1ZM, 1YM-SDIO, 1YM-PCIe, 1XK, 1XL |"
	echo "----------------------------------------------------------------------------"
	...
	$LINUX_KERNEL_6_1_1)
		...
		;;
	$LINUX_KERNEL_6_1_22)
		linuxVersion=${LINUX_KERNEL_6_1_22_STR}
		break
		;;
	*)
		echo -e "${RED}That is not a valid choice, try again.${NC}"
...
if [ "$REPLY" = "y" ] || [ "$REPLY" = "Y" ] || [ "$REPLY" = "" ]; then
	...
	if [ "$iMXYoctoRelease" = "$imxhardknottYocto52" ]; then
		...
		$REPO_PATH/repo init -u https://github.com/nxp-imx/imx-manifest -b imx-linux-mickledore -m imx-6.1.22-2.0.0.xml
	fi
